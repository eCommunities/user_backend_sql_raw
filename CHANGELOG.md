...
* switched user backend implementation to modern `OCP\User\Backend\*` interfaces while preserving dynamic capability checks
* updated PHP requirement to 8.1 - 8.4 in metadata to match Nextcloud 31
